    ...
    $Datagrid,
    {
      ...
      filtersPlaceholder: [
        /* @__PURE__ */ React.createElement(
          ...
          {
            key: "p.Encryption.SavePasswordExample_Overview.actionButton1$visibility",
            ...
            contents: [
              /* @__PURE__ */ React.createElement(
                $ActionButton,
                {
                  key: "p.Encryption.SavePasswordExample_Overview.actionButton1",
        ...
        /* @__PURE__ */ React.createElement(
          $ConditionalVisibilityWrapper,
          {
            key: "p.Encryption.SavePasswordExample_Overview.actionButton2$visibility",
            ...
            contents: [
              /* @__PURE__ */ React.createElement(
                $ActionButton,
                {
                  key: "p.Encryption.SavePasswordExample_Overview.actionButton2",
                  ...
                  action: ActionProperty({
                    "action": { "type": "openPage", "argMap": { "param$ExampleConfiguration": { "widget": "p.Encryption.SavePasswordExample_Overview.dataGrid21", "source": "selection" } }, "config": { "name": "Encryption/SavePasswordExample_NewEdit.page.xml", "location": "modal", "resizable": true, "allowedRoles": ["Administrator", "User"] }, "disabledDuringExecution": true },
                    "abortOnServerValidation": true
                  })
                }
              )
