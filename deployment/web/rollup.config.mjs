...
export default {
    ...
    plugins: [
        ...
        mendixCopy({
            sources: [
                {
                    folder: "C:/Users/jorge/Documents/Workspaces/Claude-ws/mendix-aws-kms-connector/deployment/web/widgets",
                    exclude: [".js", ".mjs", ".css"],
                    include: "**",
                },
            ],
        ...
        mendixServiceWorker({
            deploymentDir: "C:/Users/jorge/Documents/Workspaces/Claude-ws/mendix-aws-kms-connector/deployment",
        }),
